# TAD Interview Post Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Write and publish a blog post with 20 interview Q&As covering Temporal Action Detection across detection pipelines, proposal generation, temporal sentence grounding, and action segmentation & frontiers.

**Architecture:** Single Markdown file built across 4 writing tasks (each committed), then a Hugo rebuild. Sections: TAD Fundamentals & Detection Pipelines (Q1–Q5) → Temporal Proposal Generation (Q6–Q10) → Temporal Sentence Grounding (Q11–Q15) → Action Segmentation & Frontiers (Q16–Q20) → Quick Reference → Resources.
...
- Create: `content/post/Temporal Action Detection Interview Questions and Answers.md`
- Rebuild: `docs/` (via `hugo` command)

---

### Task 1: Frontmatter + Section 1 — TAD Fundamentals & Detection Pipelines (Q1–Q5)
...
```bash
grep -c "### Q" "content/post/Temporal Action Detection Interview Questions and Answers.md"
```
...
```bash
git add "content/post/Temporal Action Detection Interview Questions and Answers.md"
git commit -m "add blog post: TAD interview Q&A (Q1-Q5)"
```

---

### Task 2: Section 2 — Temporal Proposal Generation (Q6–Q10)

**Files:**
- Modify: `content/post/Temporal Action Detection Interview Questions and Answers.md`
...
```bash
git add "content/post/Temporal Action Detection Interview Questions and Answers.md"
git commit -m "add blog post: TAD interview Q&A (Q6-Q10)"
```

---

### Task 3: Section 3 — Temporal Sentence Grounding (Q11–Q15)

**Files:**
- Modify: `content/post/Temporal Action Detection Interview Questions and Answers.md`

- [ ] **Step 1: Append Q11–Q15 to the end of the file**
...
```bash
git add "content/post/Temporal Action Detection Interview Questions and Answers.md"
git commit -m "add blog post: TAD interview Q&A (Q11-Q15)"
```

---

### Task 4: Section 4 + Quick Reference + Resources (Q16–Q20)

**Files:**
- Modify: `content/post/Temporal Action Detection Interview Questions and Answers.md`

- [ ] **Step 1: Append Q16–Q20, Quick Reference, and Resources**
...
```bash
grep -c "Quick Reference\|## Resources" "content/post/Temporal Action Detection Interview Questions and Answers.md"
```
...
```bash
git add "content/post/Temporal Action Detection Interview Questions and Answers.md"
git commit -m "add blog post: TAD interview Q&A (Q16-Q20, index, resources)"
```
...
Expected: site rebuilt with no errors.

- [ ] **Step 2: Verify new post**

```bash
ls docs/post/ | grep -i "temporal"
```

Expected: `temporal-action-detection-interview-questions-and-answers/`

- [ ] **Step 3: Commit**

```bash
git add docs/
git commit -m "rebuild site: add TAD interview Q&A post"
```
