# LLM Interview Post Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Write and publish a blog post with 20 interview Q&As covering Large Language Models across pretraining, alignment, inference efficiency, and applications.

**Architecture:** Single Markdown file built across 4 writing tasks (each committed), then a Hugo rebuild. Sections: Pretraining & Architecture (Q1–Q5) → Alignment & Fine-tuning (Q6–Q10) → Inference & Efficiency (Q11–Q15) → Applications & Engineering (Q16–Q20) → Quick Reference → Resources.
...
- Create: `content/post/Large Language Models Interview Questions and Answers.md`
- Rebuild: `docs/` (via `hugo` command)

---

### Task 1: Frontmatter + Section 1 — Pretraining & Architecture (Q1–Q5)
...
```bash
grep -c "### Q" "content/post/Large Language Models Interview Questions and Answers.md"
```
...
```bash
git add "content/post/Large Language Models Interview Questions and Answers.md"
git commit -m "add blog post: LLM interview Q&A (Q1-Q5)"
```

---

### Task 2: Section 2 — Alignment & Fine-tuning (Q6–Q10)

**Files:**
- Modify: `content/post/Large Language Models Interview Questions and Answers.md`
...
```bash
git add "content/post/Large Language Models Interview Questions and Answers.md"
git commit -m "add blog post: LLM interview Q&A (Q6-Q10)"
```

---

### Task 3: Section 3 — Inference & Efficiency (Q11–Q15)
...
```bash
git add "content/post/Large Language Models Interview Questions and Answers.md"
git commit -m "add blog post: LLM interview Q&A (Q11-Q15)"
```
...
```bash
grep -c "Quick Reference\|## Resources" "content/post/Large Language Models Interview Questions and Answers.md"
```
...
```bash
git add "content/post/Large Language Models Interview Questions and Answers.md"
git commit -m "add blog post: LLM interview Q&A (Q16-Q20, index, resources)"
```
...
```bash
ls docs/post/ | grep -i "large-language"
```

Expected: `large-language-models-interview-questions-and-answers/`

- [ ] **Step 3: Commit**

```bash
git add docs/
git commit -m "rebuild site: add LLM interview post"
```
